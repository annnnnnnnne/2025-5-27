...
(function ($) {
    $.parser = {
        ...
        }, plugins: ["draggable", "droppable", "resizable", "pagination", "tooltip", "linkbutton", "menu", "menubutton", "splitbutton", "progressbar", "tree", "textbox", "filebox", "combo", "combobox", "combotree", "combogrid", "numberbox", "validatebox", "searchbox", "spinner", "numberspinner", "timespinner", "datetimespinner", "calendar", "datebox", "datetimebox", "slider", "layout", "panel", "datagrid", "propertygrid", "treegrid", "datalist", "tabs", "tabsex", "tabsexSelf", "accordion", "window", "dialog", "form"], parse: function (_2) {
            var aa = [];
...
(function ($) {
    ...
    $.messager = {
        show: function (_2a9) {
            ...
            var opts = typeof _2aa == "object" ? _2aa : { title: _2aa, msg: msg, icon: icon, fn: fn, closable: false };
            ...
            var opts = typeof _2ab == "object" ? _2ab : { title: _2ab, msg: msg, fn: fn, closable:false };
            opts = $.extend({}, $.messager.defaults, {
    ...
    $.messager.defaults = $.extend({}, $.fn.window.defaults, {
        ok: "确定", cancel: "取消", width: 300, height: "auto", modal: true, collapsible: false, minimizable: false, maximizable: false, resizable: false, fn: function () {
        }
    });
})(jQuery);
(function ($) {
...
(function ($) {
    ...
    function _317(_318, _319) {
        ...
        function _31f(p, _321) {
            ...
            p_t._outerHeight(opts.tabHeight + 1);
    ...
    $.fn.tabs.defaults = {
        width: "auto", height: "auto", headerWidth: 150, tabWidth: "auto", tabHeight: 33, selected: 0, showHeader: true, plain: false, fit: false, border: true, justified: false, narrow: false, pill: false, tools: null, toolPosition: "right", tabPosition: "top", scrollIncrement: 100, scrollDuration: 400, onLoad: function (_37e) {
...
(function ($) {
    ...
    $.fn.validatebox.defaults = {
        required: false, validType: null, validParams: null, delay: 200, missingMessage: "必填项.", invalidMessage: null, tipPosition: "right", deltaX: 0, novalidate: false, events: {
            ...
            email: {
                validator: function (_46e) {
                    ...
                    return /^([a-z0-9_\.-]+)@([\da-z\.-]+)\.([a-z\.]{2,6})$/.test(_46e);
...
(function ($) {
    ...
    function _59e(_59f) {
        ...
        设置分页高度
        */
        //if ($(_59f).datagrid('options').IsPgrid) {
        //    _5a3.children('.datagrid-header').height(35);
        //    _5a3.children('.datagrid-body').height(wrap.height() - 80);
        //    _5a4.children('.datagrid-header').height(35);
        //    _5a4.children('.datagrid-body').height(wrap.height() - 80);
        //    _5a3.height(wrap.height() - 36);
        //    _5a4.height(wrap.height() - 36);
        //}
        ////外网高度计算
        //if ($(_59f).datagrid('options').IsOuterNet) {
    ...
    function _611(_6e1, _6e2) {
        ...
        if (opts.pagination) {
            ...
            $.extend(_6e3, { pageIndex: opts.pageNumber, pageSize: opts.pageSize });
        }
        if (opts.sortName) {
            //$.extend(_6e3,{sort:opts.sortName,order:opts.sortOrder});
            var _orderby = opts.sortOrder.length > 0 ? opts.sortName + "_" + opts.sortOrder : opts.sortName;
            $.extend(_6e3, { orderBy: _orderby });
        }
    ...
    $.fn.datagrid.methods = {
        options: function (jq) {
            ...
            return jq.each(function () {
                ...
                /*
                            *flag为扩展属性，控制是否重新渲染自定义分页
                            */
                if (typeof (opts.flag) != 'undefined') {
                    opts.flag = true;
                }
    ...
    var _745 = {
        render: function (_746, _747, _748) {
            ...
            if (_75a && opts.rownumbers) {
                ...
                //修改序号不能累计
                var _num = Number($("#" + opts.id).parents('.datagrid').next().find('.current').text());
                if (opts.extend != 'undefined' && opts.extend && _num > 0) {
                    _75d += (_num - 1) * opts.pageSize;
                }
...
(function ($) {
    ...
    $.fn.datebox.defaults = $.extend({}, $.fn.combo.defaults, {
        ...
        }, currentText: "今天", cleanText:"清空",closeText: "关闭", okText: "确定", buttons: [{
            text: function (_a0b) {
		...
		{
            text: function (_a0d) {
                return $(_a0d).datebox("options").cleanText;
